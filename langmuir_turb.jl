...
model = NonhydrostaticModel(; grid, buoyancy, coriolis,
                            advection = WENO(),
                            tracers = (:T,),
                            timestepper = :RungeKutta3, #chemical kinetics are embedded inthis timestepper
...
simulation.callbacks[:progress] = Callback(progress, IterationInterval(3000))
